...
Si vous ne pouvez pas modifier le type d'instance à partir d'instances c4, m4 ou r4, consultez l'article de la base de connaissances link:https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/Converting_an_AWS_Xen_CVO_instance_to_Nitro_(KVM)["Conversion d'une instance AWS Xen CVO en Nitro (KVM)"^].
