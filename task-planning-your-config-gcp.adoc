...
Cloud Volumes ONTAP est pris en charge dans la plupart des régions Google Cloud. https://["Afficher la liste complète des régions prises en charge"^].
...
https://["Configurations prises en charge pour Cloud Volumes ONTAP dans GCP"^]
...
https://["Limites de stockage pour Cloud Volumes ONTAP dans GCP"^]
...
+
Pour plus de détails, voir https://["Documentation Google Cloud : disques persistants zonés (standard et SSD)"^].
...
+
** https://["Documentation Google Cloud : disques persistants zonés (standard et SSD)"^]
** https://["Documentation Google Cloud : optimisation des performances des disques persistants et des SSD locaux"^]
...
* https://["Documents Google Cloud : quotas de ressources"^]
+
