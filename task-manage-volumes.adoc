...
.Étapes
. Ouvrez la vue avancée pour redimensionner un volume à l'aide du Gestionnaire système ONTAP. Reportez-vous à la link:task-administer-advanced-view.html#how-to-get-started["Comment démarrer"].
