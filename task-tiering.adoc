...
----
Les autorisations sont incluses dans le rôle personnalisé par défaut. https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-permissions-azure.html["Afficher l'autorisation Azure pour le connecteur"^]
...
+
Pour obtenir de l'aide sur la réplication des données, voir https://docs.netapp.com/us-en/cloud-manager-replication/task-replicating-data.html["Réplication des données depuis et vers le cloud"^].
