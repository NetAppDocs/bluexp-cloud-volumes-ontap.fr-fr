...
* http://["Documentation AWS : types de volume EBS"^]
...
* https://["Consultez les limites de stockage pour Cloud Volumes ONTAP dans AWS"^]
* http://["Étude des configurations pour Cloud Volumes ONTAP prises en charge dans AWS"^]
...
* https://["Documentation Microsoft Azure : types de disques gérés Azure"^]
* https://["Documentation Microsoft Azure : présentation des objets blob de pages Azure"^]
...
* https://["Consultez les limites de stockage pour Cloud Volumes ONTAP dans Azure"^]
...
* https://["Documentation Google Cloud : options de stockage"^]
* https://["Consultez les limites de stockage de Cloud Volumes ONTAP dans Google Cloud"^]
