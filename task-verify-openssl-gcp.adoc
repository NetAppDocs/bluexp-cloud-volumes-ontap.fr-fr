...
[role="lead"]
Vous pouvez vérifier le fichier Disk.RAW téléchargé de Google Cloud par rapport au contenu du fichier condensé disponible via le https://["NSS"^] Utilisation d'OpenSSL.
