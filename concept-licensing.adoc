...
IMPORTANT: NetApp mettra fin à la disponibilité des licences basées sur les nœuds sous peu. Une fois la disponibilité terminée, les licences basées sur les nœuds doivent être converties en licences basées sur la capacité. Pour plus d'informations, reportez-vous à https://mysupport.netapp.com/info/communications/CPC-00589.html["Communiqué à la clientèle : CPC-00589"^]la .
