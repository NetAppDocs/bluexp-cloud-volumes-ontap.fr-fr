...
* Inclut des sauvegardes de volume illimitées avec Cloud Backup, mais uniquement pour les systèmes Cloud Volumes ONTAP qui utilisent le pack professionnel
* Ajoutez des services de données cloud de NetApp à vos frais supplémentaires
