...
NOTE: Le stockage et l'utilisation du réseau sont calculés en gigaoctets binaires (Go), où 1 Go correspond à 2^30 octets. Cette unité de mesure est également appelée gibioctet (Gio). De même, 1 To correspond à 2^40 octets, soit 1024 Go.
...
* Pour Azure : E4S_v3, E4ds_v4, DS4_v2, DS13_v2, E8s_v3, E8ds_v4, E4ds_v5 et E8ds_v5
...
NOTE: Un abonnement PAYGO est requis pour la sauvegarde et la restauration BlueXP. Toutefois, aucun frais n'est requis pour l'utilisation de ce service. Pour plus d'informations sur la configuration des licences pour la sauvegarde et la restauration BlueXP, reportez-vous à la section https://docs.netapp.com/us-en/bluexp-backup-recovery/task-licensing-cloud-backup.html["Configurez les licences pour la sauvegarde et la restauration BlueXP"^].
