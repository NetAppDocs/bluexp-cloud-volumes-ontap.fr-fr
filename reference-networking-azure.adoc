...
TIP: Vous recherchez des informations sur le connecteur ? https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-ports-azure.html["Afficher les règles de groupe de sécurité du connecteur"^]
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html["Afficher les exigences de mise en réseau du connecteur"^]
