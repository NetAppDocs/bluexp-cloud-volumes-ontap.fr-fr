...
+
** Vous devez avoir un https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html["Connecteur associé à votre espace de travail"^].
...
. Si vous y êtes invité, https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html["Créer un connecteur"^].
...
** Pour obtenir de l'aide sur l'ajout d'un compte Google Cloud, consultez la section https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-gcp-accounts.html["Configuration et ajout de comptes Google Cloud pour le Tiering des données avec 9.6"^].
...
| Nom du compte de service | Si vous avez l'intention d'utiliser le link:concept-data-tiering.html["tiering des données"] ou https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["sauvegarde et restauration"^] Services, vous devez activer le commutateur *compte de service*, puis sélectionner le compte de service qui a le rôle d'administrateur de stockage prédéfini. 
