...
NOTE: Pour les régions chinoises, les déploiements à un seul nœud sont pris en charge uniquement dans Cloud Volumes ONTAP 9.12.1 GA et 9.13.0 GA. Vous pouvez mettre à niveau ces versions vers les versions et correctifs ultérieurs de Cloud Volumes ONTAP. Si vous souhaitez déployer des versions Cloud Volumes ONTAP ultérieures dans les régions chinoises, contactez le support NetApp. Seules les licences achetées directement auprès de NetApp sont prises en charge dans ces régions.
