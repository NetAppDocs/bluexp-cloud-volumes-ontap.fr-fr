...
. *Abonnez-vous à Azure Marketplace* : vous voyez cette page si BlueXP n'a pas pu activer les déploiements de programmation de Cloud Volumes ONTAP. Suivez les étapes indiquées à l'écran. Voir https://learn.microsoft.com/en-us/marketplace/programmatic-deploy-of-marketplace-products["Déploiement programmatique des produits Marketplace"^] pour en savoir plus.
