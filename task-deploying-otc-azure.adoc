...
TIP: Si le compte Azure que vous utilisez possède le https://["autorisations requises"^], BlueXP supprime les ressources Cloud Volumes ONTAP d'un groupe de ressources, en cas d'échec ou de suppression du déploiement.
