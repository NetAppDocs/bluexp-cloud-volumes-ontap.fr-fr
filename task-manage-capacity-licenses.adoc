...
https://["En savoir plus sur les licences Cloud Volumes ONTAP"].
...
+
Pour mieux comprendre les capacités affichées dans le pack Essentials, vous devez connaître le fonctionnement de la charge. https://["En savoir plus sur le chargement pour le pack Essentials"].
...
* Pour saisir le numéro de série, vous devez d'abord le faire https://["Ajoutez votre compte sur le site de support NetApp à BlueXP"^]. Il s'agit du compte du site de support NetApp autorisé à accéder au numéro de série.
