...
NOTE: Pour plus d'informations sur l'obtention d'un fichier de licence, reportez-vous à la section https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-manage-node-licenses.html#obtain-a-system-license-file["Obtenir un fichier de licence système"^].
