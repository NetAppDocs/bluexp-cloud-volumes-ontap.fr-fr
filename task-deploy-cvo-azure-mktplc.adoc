...
NOTE: Le déploiement direct d'Azure Marketplace prend en charge les types d'instances L8S_v3. Cependant, BlueXP  ne prend pas en charge ce type d'instance pour les configurations haute disponibilité et ne pourra pas le détecter correctement lors de la découverte.
