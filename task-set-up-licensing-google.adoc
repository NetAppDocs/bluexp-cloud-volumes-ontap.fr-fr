...
TIP: Vous pouvez gérer les abonnements Google Cloud Marketplace associés à vos comptes à partir de la page Paramètres > informations d'identification. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-gcp-accounts.html["Découvrez comment gérer vos identifiants et abonnements Google Cloud"^]
