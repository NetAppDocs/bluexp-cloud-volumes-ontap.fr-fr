...
Si vous n'avez pas de https://["Connecteur"^] Cependant, un administrateur de compte doit en créer un. https://["Découvrez comment créer un connecteur dans AWS"^]
...
* https://["Lancement d'un connecteur depuis AWS Marketplace"^]
* https://["Installation du logiciel du connecteur sur un hôte Linux"^]
* https://["Ce que BlueXP fait avec les autorisations AWS"^]
