...
BlueXP alloue 14 ou 15 adresses IP privées à une paire haute disponibilité dans Google Cloud :
...
=== Connexion à Google Cloud Storage pour le Tiering des données
