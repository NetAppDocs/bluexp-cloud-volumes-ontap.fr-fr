...
https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html["Vérifiez les autorisations VPC partagées requises couvertes par le déploiement du connecteur"^]
