...
NOTE: Pour plus d'informations sur l'installation d'Azure CLI, voir https://learn.microsoft.com/en-us/cli/azure/install-azure-cli["Documentation Azure : installation de l'interface de ligne de commandes Azure"^].
