...
La fonctionnalité ARP est disponible pour les abonnements BYOL et Marketplace, tant pour les licences basées sur des nœuds que pour les licences basées sur la capacité, sans frais supplémentaires. Contactez votre ingénieur commercial NetApp pour ajouter ARP à votre licence actuelle.
...
Lors de l'achat d'une licence complémentaire et de son ajout au portefeuille digital, vous pouvez activer le protocole ARP par volume avec Cloud Volumes ONTAP.

Les volumes ARP activés ont un état désigné « mode apprentissage » ou « actif ».
