...
Cloud Volumes ONTAP prend désormais en charge les machines virtuelles de la série Edv5 suivantes avec des disques gérés partagés dans une ou plusieurs zones de disponibilité, à partir de la version 9.14.1.
