...
Pour plus d'informations sur les systèmes pris en chargelink:https://aws.amazon.com/about-aws/global-infrastructure/localzones/features/?nc=sn&loc=2["Types d'instances EC2 dans les zones locales"^], reportez-vous à la documentation AWS .
