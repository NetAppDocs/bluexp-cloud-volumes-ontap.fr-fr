...
Si vous n'avez pas de https://["Connecteur"^] Cependant, un administrateur de compte doit en créer un. https://["Découvrez comment créer un connecteur dans Azure"^]
...
* https://["Création d'un connecteur à partir d'Azure Marketplace"^]
* https://["Installation du logiciel du connecteur sur un hôte Linux"^]
* https://["Ce que BlueXP fait avec les autorisations"^]
